...
/// `ink` / `inv` 是反色条，`accent` 取这套配色里已经出现的描边或面板色。
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
...
fn themes() -> [Theme; 13] {
    ...
    [
        ...
        theme(
            ...
            "CRT 绿屏",
            [
                0x0A1A0A, 0x102410, 0x102410, 0x1A3A1A, 0x33FF66, 0x22CC55, 0x0A1A0A, 0x33FF66,
            ],
        ),
        theme(
            Amber,
            ...
            "琥珀 Amber",
            [
                0x1A1208, 0x241808, 0x241808, 0x3A2810, 0xFFB000, 0xE09000, 0x1A1208, 0xFFB000,
            ],
        ),
        theme(
            Blueprint,
            ...
            "蓝纸 Blueprint",
            [
                0x0B1F3A, 0x123052, 0x123052, 0x1A4068, 0xE8F0FF, 0x7EB6FF, 0x0B1F3A, 0x7EB6FF,
            ],
        ),
        theme(
            Cyber,
            ...
            "赛博 Cyber",
            [
                0x0D0D12, 0x16161F, 0x16161F, 0x222233, 0xE6E6F0, 0x00F0FF, 0x0D0D12, 0x00F0FF,
            ],
        ),
        theme(
            WarmPaper,
            ...
            "纸感暖白",
            [
                0xF7F1E8, 0xEFE6D8, 0xEFE6D8, 0xE2D5C2, 0x2C241B, 0x5C4A3A, 0xF7F1E8, 0x5C4A3A,
            ],
        ),
        theme(
            Graphite,
            ...
            "石墨 Graphite",
            [
                0x1C1C1E, 0x2A2A2E, 0x2A2A2E, 0x3A3A40, 0xF2F2F2, 0x8E8E93, 0x1C1C1E, 0x8E8E93,
            ],
        ),
        theme(
            Sakura,
            ...
            "樱花 Sakura",
            [
                0xFFF5F7, 0xE591A7, 0xFFE8EE, 0xFFD6E0, 0x3D2A32, 0xE89AAB, 0xFFF5F7, 0xE591A7,
            ],
        ),
        theme(
            Forest,
            ...
            "森林 Forest",
            [
                0xF2F6F1, 0xE4EDE2, 0xE4EDE2, 0xD0DFCC, 0x1B2E1F, 0x2F5D3A, 0xF2F6F1, 0x2F5D3A,
            ],
        ),
        theme(
            Sunset,
            ...
            "日落 Sunset",
            [
                0x1A0F14, 0x2A1520, 0x2A1520, 0x3D1F2E, 0xFFE8D6, 0xFF6B4A, 0x1A0F14, 0xFF6B4A,
            ],
        ),
        theme(
            Ice,
            ...
            "冰蓝 Ice",
            [
                0xF4F8FC, 0xE6EEF6, 0xE6EEF6, 0xD0DCEB, 0x0F1C2E, 0x2B4C7E, 0xF4F8FC, 0x2B4C7E,
            ],
        ),
        theme(
            Grape,
            ...
            "葡萄 Purple",
            [
                0x16121F, 0x221A2E, 0x221A2E, 0x322640, 0xF0E6FF, 0xA78BFA, 0x16121F, 0xA78BFA,
            ],
        ),
    ]
}
...
pub(super) fn theme_picker(ui: &mut egui::Ui, current: &mut ThemeId) -> bool {
    ...
    egui::ComboBox::from_id_salt("keydesk-theme-picker")
        ...
        .show_ui(ui, |ui| {
            ...
            for theme in themes() {
                ui.horizontal(|ui| {
                    palette_swatch(ui, theme, ui.spacing().interact_size.y);
...
/// 一个方块里的四格：底色、面板、文字色、强调色。
pub(super) fn palette_swatch(ui: &mut egui::Ui, theme: Theme, size: f32) {
    let (rect, _) = ui.allocate_exact_size(egui::vec2(size, size), egui::Sense::hover());
    let half = size / 2.0;
    let cells = [
        (egui::vec2(0.0, 0.0), theme.bg),
        (egui::vec2(half, 0.0), theme.panel),
        (egui::vec2(0.0, half), theme.ink),
        (egui::vec2(half, half), theme.accent),
    ];
    for (offset, color) in cells {
        ui.painter().rect_filled(
            egui::Rect::from_min_size(rect.min + offset, egui::vec2(half, half)),
            0.0,
            color,
        );
    }
    ...
    fn palettes_match_hex() {
        ...
        let cases = [
            ...
            (
                ...
                true,
                [
                    0x0A1A0A, 0x102410, 0x1A3A1A, 0x33FF66, 0x22CC55, 0x0A1A0A, 0x33FF66,
                ],
            ),
            (
                "amber",
                ...
                true,
                [
                    0x1A1208, 0x241808, 0x3A2810, 0xFFB000, 0xE09000, 0x1A1208, 0xFFB000,
                ],
            ),
            (
                "blueprint",
                ...
                true,
                [
                    0x0B1F3A, 0x123052, 0x1A4068, 0xE8F0FF, 0x7EB6FF, 0x0B1F3A, 0x7EB6FF,
                ],
            ),
            (
                "cyber",
                ...
                true,
                [
                    0x0D0D12, 0x16161F, 0x222233, 0xE6E6F0, 0x00F0FF, 0x0D0D12, 0x00F0FF,
                ],
            ),
            (
                "warm_paper",
                ...
                false,
                [
                    0xF7F1E8, 0xEFE6D8, 0xE2D5C2, 0x2C241B, 0x5C4A3A, 0xF7F1E8, 0x5C4A3A,
                ],
            ),
            (
                "graphite",
                ...
                true,
                [
                    0x1C1C1E, 0x2A2A2E, 0x3A3A40, 0xF2F2F2, 0x8E8E93, 0x1C1C1E, 0x8E8E93,
                ],
            ),
            (
                "sakura",
                ...
                false,
                [
                    0xFFF5F7, 0xFFE8EE, 0xFFD6E0, 0x3D2A32, 0xE89AAB, 0xFFF5F7, 0xE591A7,
                ],
            ),
            (
                "forest",
                ...
                false,
                [
                    0xF2F6F1, 0xE4EDE2, 0xD0DFCC, 0x1B2E1F, 0x2F5D3A, 0xF2F6F1, 0x2F5D3A,
                ],
            ),
            (
                "sunset",
                ...
                true,
                [
                    0x1A0F14, 0x2A1520, 0x3D1F2E, 0xFFE8D6, 0xFF6B4A, 0x1A0F14, 0xFF6B4A,
                ],
            ),
            (
                "ice",
                ...
                false,
                [
                    0xF4F8FC, 0xE6EEF6, 0xD0DCEB, 0x0F1C2E, 0x2B4C7E, 0xF4F8FC, 0x2B4C7E,
                ],
            ),
            (
                "grape",
                ...
                true,
                [
                    0x16121F, 0x221A2E, 0x322640, 0xF0E6FF, 0xA78BFA, 0x16121F, 0xA78BFA,
                ],
            ),
        ];
